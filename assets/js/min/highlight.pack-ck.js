var hljs = new (function () {
      ...
      (function n(e, a) {
        for (var i = e.firstChild; i; i = i.nextSibling)
          3 == i.nodeType
            ...
            ? (a += 1)
            : 1 == i.nodeType &&
              (r.push({ event: "start", offset: a, node: i }),
              (a = n(i, a)),
              r.push({ event: "stop", offset: a, node: i }));
        return a;
      })(e, 0),
      r
    );
  ...
  function s(r, n, a) {
    ...
    function c(r) {
      ...
      u +=
        "<" + t(r) + Array.prototype.map.call(r.attributes, n).join("") + ">";
    }
    function s(e) {
      u += "</" + t(e) + ">";
    }
    ...
    for (var l = 0, u = "", b = []; r.length || n.length; ) {
      ...
      if (((u += e(a.substr(l, d[0].offset - l))), (l = d[0].offset), d == r)) {
        b.reverse().forEach(s);
        do o(d.splice(0, 1)[0]), (d = i());
        while (d == r && d.length && d[0].offset == l);
        b.reverse().forEach(c);
      } else
  ...
  function l(t, n, a, i) {
    ...
    function g() {
      if (k.sL && !v[k.sL]) return e(x);
      var t = k.sL ? l(k.sL, x, !0, k.continuation.top) : u(x);
      return (
        k.r > 0 && (C += t.r),
        "continuous" == k.subLanguageMode && (k.continuation.top = t.top),
    ...
    function _(t, r) {
      if (((x += t), void 0 === r)) return (M += h()), 0;
      var n = c(r, k);
      if (n) return (M += h()), w(n, r), n.rB ? 0 : r.length;
      var a = s(k, r);
      if (a) {
        var i = k;
        i.rE || i.eE || (x += r), (M += h());
        do k.cN && (M += "</span>"), (C += k.r), (k = k.parent);
        while (k != a.parent);
        return (
          i.eE && (M += e(r)),
          (x = ""),
      ...
      if (b(r, k))
        throw new Error(
          'Illegal lexeme "' + r + '" for mode "' + (k.cN || "<unnamed>") + '"',
        );
    ...
    o(y);
    for (var k = i || y, M = "", E = k; E != y; E = E.parent)
      E.cN && (M = p(E.cN, M, !0));
    var x = "",
      C = 0;
    try {
      for (var L, B, I = 0; ; ) {
        if (((k.t.lastIndex = I), (L = k.t.exec(n)), !L)) break;
        (B = _(n.substr(I, L.index - I), L[0])), (I = L.index + B);
      }
      _(n.substr(I));
      for (var E = k; E.parent; E = E.parent) E.cN && (M += "</span>");
      return { r: C, value: M, language: t, top: k };
    } catch (S) {
      if (-1 != S.message.indexOf("Illegal")) return { r: 0, value: e(n) };
      throw S;
    }
  }
  function u(t, r) {
  ...
  function b(e) {
    return (
      N.tabReplace &&
        (e = e.replace(/^((<[^>]+>|\t)+)/gm, function (e, t, r, n) {
  ...
  (this.highlight = l),
    ...
    (this.fixMarkup = b),
    (this.highlightBlock = d),
    (this.configure = p),
    (this.initHighlighting = f),
    (this.initHighlightingOnLoad = g),
    (this.registerLanguage = h),
    (this.getLanguage = m),
    (this.inherit = i),
...
hljs.registerLanguage("bash", function (e) {
    ...
    return {
      ...
      c: [
        ...
        e.CNM,
        {
          ...
          k: t,
          c: [
            { bK: "class namespace interface", starts: { c: [e.TM] } },
            { b: e.IR + "\\s*\\(", rB: !0, c: [e.TM] },
          ],
        },
      ],
    };
    ...
    return {
      ...
      c: [
        ...
        },
        {
          ...
          c: [
            { cN: "keyword", b: /\S+/ },
            { b: /\s/, eW: !0, eE: !0, r: 0, c: [r, e.ASM, e.QSM, e.NM] },
          ],
        },
        { cN: "tag", b: t, r: 0 },
        {
  ...
  hljs.registerLanguage("python", function (e) {
    ...
    return {
      ...
      c: [
        ...
        r,
        e.HCM,
        e.inherit(i, { cN: "function", bK: "def", r: 10 }),
        e.inherit(i, { cN: "class", bK: "class" }),
        { cN: "decorator", b: /@/, e: /$/ },
        { b: /\b(print|exec)\(/ },
      ],
    };
  ...
  hljs.registerLanguage("perl", function (e) {
    var t =
      ...
      i = { cN: "comment", b: "^(__END__|__DATA__)", e: "\\n$", r: 5 },
      c = [e.BE, r, a],
      s = [
        a,
        e.HCM,
    ...
    return (
      (a.c = i),
      {
        ...
        c: i.concat([
          ...
          { cN: "attribute", b: r + ":", e: ":", rB: !0, eE: !0, r: 0 },
        ]),
      }
    );
  }),
